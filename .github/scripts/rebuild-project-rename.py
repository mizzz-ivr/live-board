...
project_ops = Path("packages/domain/src/workspace-projects.ts")
project_ops.write_text(
    project_ops.read_text()
    + """
...
Path("packages/domain/src/workspace-commands.ts").write_text(
    """import {
  DomainError,
  cloneProject,
  type Project,
